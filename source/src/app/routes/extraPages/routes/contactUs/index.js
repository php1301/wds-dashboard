                    ...
                    <ul className="contact-info vertical">
                        ...
                        <li>
                            ...
                            <div className="contact-body">
                                ...
                                <div><a href="javascript:void(0)" className="text-primary disable-link">01 (800) 433 544</a>
                                </div>
                                <div><a href="javascript:void(0)" className="text-primary disable-link">01 (800) 123 524</a>
                                </div>
                            </div>
                        </li>
                        ...
                        <li>
                            ...
                            <div className="contact-body">
                                ...
                                <div><a className="text-primary" href="javascript:void(0)">info@Example.com</a></div>
