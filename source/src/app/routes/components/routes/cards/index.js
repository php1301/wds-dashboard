...
const Cards = ({match}) => {
    return (
        <div className="animated slideInUpTiny animation-duration-3">
            <ContainerHeader title="Cards" match={match} />

            <div className="jr-entry-header">
                <h3 className="entry-heading">Basic Cards</h3>
            </div>
            ...
            <div className="jr-entry-header">
                <h3 className="entry-heading">Special Cards</h3>
            </div>
            ...
            <div className="jr-entry-header">
                <h3 className="entry-heading">Cards with Header, Footer and Alignment</h3>
            </div>
            ...
            <div className="jr-entry-header">
                <h3 className="entry-heading">Navigational Cards</h3>
            </div>
            ...
            <div className="jr-entry-header">
                <h3 className="entry-heading">Image Cards</h3>
            </div>
            ...
            <div className="jr-entry-header">
                <h3 className="entry-heading">Solid Cards</h3>
            </div>
