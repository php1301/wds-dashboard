...
function InsetAvatarDividers() {
    return (
        <List>
            <ListItem button>
                <Avatar className="size-50" alt="Remy Sharp" src="http://via.placeholder.com/256x256" />
            ...
            <Divider inset />
            <ListItem button>
                <Avatar className="size-50" alt="Adelle Charles" src="http://via.placeholder.com/256x256" />
