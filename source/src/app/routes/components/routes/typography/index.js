...
const Typography = ({match}) => {
    return (
        <div className="animated slideInUpTiny animation-duration-3">
            <ContainerHeader title="Typography" match={match} />

            <div className="row mb-md-4">

                <CardBox styleName="col-sm-6 col-12" heading="Light Headings" headerOutside>
                    <div>
                ...
                <CardBox styleName="col-sm-6 col-12" heading="Normal Headings" headerOutside>
                    <div>
                        <h1>Heading 1
                            <small> Sub-heading</small>
                        </h1>
            ...
            <div className="row mb-md-4">
                <CardBox styleName="col-sm-6 col-12" heading="Semi-bold Headings" headerOutside>
                    <div>
                ...
                <CardBox styleName="col-sm-6 col-12" heading="Bold Headings" headerOutside>
                    <div>
            ...
            <div className="row mb-md-4">
                <CardBox styleName="col-md-6 col-12" heading="Paragraph Text" headerOutside>
                    <div>
                ...
                <CardBox styleName="col-md-6 col-12" heading="Lead Paragraph Text" headerOutside>
                    <div>
            ...
            <div className="row mb-md-4">
                <CardBox styleName="col-lg-4 col-sm-6 col-12" heading="Unstyled List" headerOutside>
                ...
                <CardBox styleName="col-lg-4 col-sm-6 col-12" heading="Ordered List" headerOutside>
                    <ol className="mb-0">
                        <li>Donec imperdiet enim et</li>
                        <li>Gignissim interdum pellentesque</li>
                        <li>In porttitor elit curabitur
                ...
                <CardBox styleName="col-lg-4 col-sm-6 col-12" heading="Unordered List" headerOutside>
                    <ul className="mb-0">
                        <li>Donec imperdiet enim et</li>
                        <li>Gignissim interdum pellentesque</li>
                        <li>In porttitor elit curabitur
                ...
                <CardBox styleName="col-lg-4 col-sm-6 col-12" heading="List With Icons" headerOutside>
                ...
                <CardBox styleName="col-lg-4 col-sm-6 col-12" heading="Compact List" headerOutside>
                    <ol className="mb-0">
                        <li>Donec imperdiet enim et</li>
                        <li>Gignissim interdum pellentesque</li>
                        <li>In porttitor elit curabitur
                ...
                <CardBox styleName="col-lg-4 col-sm-6 col-12" heading="Extended List" headerOutside>
                    <ul className="mb-0">
                        <li>Donec imperdiet enim et</li>
                        <li>Gignissim interdum pellentesque</li>
                        <li>In porttitor elit curabitur
                ...
                <CardBox styleName="col-lg-4 col-sm-6 col-12" cardStyle="p-0" heading="Left Icon Grouped List"
                         headerOutside>
                    <LeftIconList />
                </CardBox>

                <CardBox styleName="col-lg-4 col-sm-6 col-12" cardStyle="p-0" heading="Right Icon Grouped List"
                         headerOutside>
                    <RightIconList />
                </CardBox>

                <CardBox styleName="col-lg-4 col-12" cardStyle="p-0" heading="Badges Grouped List" headerOutside>
                    <BadgeIconList />
                </CardBox>
            </div>

            <div className="row mb-md-4">
                <CardBox styleName="col-md-6 col-12" heading="Default Description List" headerOutside>
                ...
                <CardBox styleName="col-md-6 col-12" heading="Even-Odd Description List" headerOutside>
            ...
            <div className="row mb-md-4">
                <CardBox styleName="col-md-6 col-12" heading="Left Blockquote With Author Avatar" headerOutside>
                ...
                <CardBox styleName="col-md-6 col-12" heading="Right Blockquote With Author Avatar" headerOutside>
