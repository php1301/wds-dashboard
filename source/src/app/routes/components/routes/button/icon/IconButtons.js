    ...
    return (
        <div>
            <div className="jr-btn-group">
                <Button variant="raised" className="jr-btn jr-btn-label left bg-primary text-white">
                    <i className="zmdi zmdi-headset zmdi-hc-fw " />
                    <span>Labeled</span>
                </Button>

                <Button variant="raised" className="jr-btn jr-btn-label right bg-primary text-white">
