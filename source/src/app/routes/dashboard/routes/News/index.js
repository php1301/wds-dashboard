    ...
    render() {
        return (
            <div className="dashboard animated slideInUpTiny animation-duration-3">
                <ContainerHeader match={this.props.match} title="news"/>
                ...
                <div className="row">
                    <div className="col-lg-5">
                        <div className="jr-card">
                            <CardHeader heading="Popular Authors"
                                        subHeading="Authors With 500+ avg. view" styleName="mb-2"/>
                    ...
                    <div className="col-lg-7">
                        <div className="jr-card">
                            <CardHeader heading="Popular Articles"
                                        subHeading="Lorem ipsum is dummy content dollar sit is..." styleName="mb-4"/>
                ...
                <div className="row">
                    <div className="col-xl-7 col-lg-6 col-md-7 col-12">
                        <div className="jr-card">
                            <CardHeader heading="Comments"
                                        subHeading="" styleName="mb-2"/>
                            <Comments/>
                        </div>
                    </div>
                    ...
                    <div className="col-xl-5 col-lg-6 col-md-5 col-12">
                        <div className="jr-card">
                            <CardHeader heading="Your Daily Feed"
                                        subHeading="" styleName="mb-2"/>
                            <YourDailyFeed/>
                        </div>
                    </div>
