                ...
                <div className="row">
                            ...
                            <div className="row">
                                ...
                                <div className="col-sm-7 col-12 text-sm-left text-center align-self-center">
                                    <div className="jr-card-header mb-2">
                                        <h3 className="card-heading">Google insight score</h3>
                                        <p className="sub-heading">Las calculated 1 month ago</p>
                                    </div>
                    ...
                    <div className="col-lg-2 col-sm-4 col-12">
                        <div className="jr-card bg-primary text-white text-center py-5">
                            <div className="mb-3">
                                <img src="http://via.placeholder.com/54x54" alt="image"/>
                            </div>
                ...
                <div className="row">
                    ...
                    <div className="col-lg-5 col-sm-6 col-12">
                        <div className="jr-card">
                            ...
                            <div className="py-3">
                                <a href="javascript:void(0)" className="card-link text-uppercase text-primary">VIEW ALL
                                    POSTS</a>
                            </div>
                        </div>
                    </div>
